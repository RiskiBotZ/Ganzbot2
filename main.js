...
conn.connect().then(() => {
 conn.sendMessage('6281339888334@c.us', '[Bot Sudah Siap Di Gunakan]', 'conversation');
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai @user \nwah ada beban baru ni ayok bully dia!!'
  conn.bye = 'ya kasihan pasti karena di bully mulu @user!'
  conn.spromote = '@user Sekarang Admin!'
  conn.sdemote = '@user Sekarang Bukan Admin awowkwok!'
